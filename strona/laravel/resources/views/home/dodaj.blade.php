...
<section data-bs-version="5.1" class="gallery2 cid-tEaf5u0Mmy" id="gallery2-o">
    ...
    <div class="container">
        <div class="mbr-section-head text-white">
            <h4 class="mbr-section-title text-white mbr-fonts-style align-center mb-0 display-2"><strong>Dodaj część</strong></h4>
            <form action="{{ route('dodaj-rekord') }}" method="POST">
                @csrf
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="numer_seryjny" required>
                </div>
                <div>
                ...
                <button class="text-white" type="submit">Dodaj rekord</button>
            </form>
