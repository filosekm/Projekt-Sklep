...
<section data-bs-version="5.1" class="gallery2 cid-tEaf5u0Mmy" id="gallery2-o">
    ...
    <div class="container">
        <div class="mbr-section-head">
            <h4 class="mbr-section-title mbr-fonts-style align-center mb-0 display-2"><strong>Projekt Wykonali:</strong></h4>
            <br></br>
            <h4 class="mbr-section-title mbr-fonts-style align-center mb-0 display-2">{{ $author1}}</h4>
            <br></br>
            <h4 class="mbr-section-title mbr-fonts-style align-center mb-0 display-2">{{ $author2}}</h4>
            <br></br>
            <h4 class="mbr-section-title mbr-fonts-style align-center mb-0 display-2">{{ $author3}}</h4>
